...
#ifdef _WIN64
#pragma comment(lib,"../Library/msc_x64.lib") //x64
#else
#pragma comment(lib,"../Library/msc.lib") //x86
#endif
...
{
	char *o = new char[strlen(session_para) + 1];
	strcpy(o, session_para);

	char *s;
	if ((s = strstr(o, "sample_rate"))) {
		if (s = strstr(s, "=")) {
			s = skip_space(s);
			if (s && *s) {
